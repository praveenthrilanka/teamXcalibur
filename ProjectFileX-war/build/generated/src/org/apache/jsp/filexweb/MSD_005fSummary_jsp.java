...
public final class MSD_005fSummary_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.print(e.getDepartement());
 ...
 out.print(session.getAttribute("home")); 
      ...
      out.write("\r\n");
      out.write("@media all {\r\n");
      out.write("\t.page-break\t{ display: none; }\r\n");
      out.write("}    \r\n");
      out.write("    \r\n");
      out.write("@media print{\r\n");
      out.write("  body{ background-color:#FFFFFF; background-image:none; color:#000000 ;position: absolute; top: 0; left: 0;}\r\n");
      out.write("  .page-sidebar { display:none;}\r\n");
      out.write("  .page-topbar { display:none;}\r\n");
      out.write("  .page-title { display:none;}\r\n");
      out.write("  .box{ position: absolute; width:100%; height: 100%; position:fixed;\r\n");
      out.write("    padding:0;\r\n");
      out.write("    margin:0;\r\n");
      out.write("\r\n");
      out.write("    top:0;\r\n");
      ...
      out.write("  .content-body{position: absolute;left:0;}\r\n");
      out.write("  .page-break\t{ display: block; page-break-before: always; }\r\n");
      out.write("}\r\n");
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("                <div class=\"pull-left\">\r\n");
      out.write("                    <h1 class=\"title\">Version History</h1>                            \r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        ");
      ...
      out.write("                    <h2 class=\"title pull-left\">");
 out.print(p.getProjectname()); 
      out.write("</h2>\r\n");
      out.write("                </header>\r\n");
      ...
      out.write("                        <div class=\"col-md-11 col-sm-11 col-xs-11\">\r\n");
      out.write("\r\n");
      out.write("                            <div class=\"uprofile_wall_posts col-md-12 col-sm-12 col-xs-12\">\r\n");
      out.write("                                <div class=\"pic-wrapper col-md-1 col-sm-1 col-xs-2 text-center\">\r\n");
      out.write("                                    <img src=\"../GetIconByID?id=");
 out.print(msd.getEmployeeid()); 
      out.write("\" class=\"\" alt=\"\">\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"info-wrapper col-md-11 col-sm-11 col-xs-10\">\t\t\t\t\t\r\n");
      out.write("                                    <div class=\"username\">\r\n");
      out.write("                                        <span>Manager SD </span><span class=\"bold\">");
 out.print(msd.getEmployeename()); 
      out.write("</span> Created the Project <span class=\"bold\">");
 out.print(p.getProjectname()); 
      out.write("</span>\t\r\n");
      out.write("                                    </div>\r\n");
      out.write("                                    <div class=\"info text-muted\">\r\n");
      out.write("                                        <span>Assigned Project Manager : </span><span class=\"bold\">");
 out.print(pm.getEmployeename()); 
      out.write("</span><br/>\r\n");
      out.write("                                        <span>Assigned Business Analyst : </span><span class=\"bold\">");
 out.print(ba.getEmployeename()); 
      out.write("</span>\r\n");
      out.write("                                    </div>\t\r\n");
      out.write("                                    <div class=\"info-details\">\r\n");
      out.write("                                        <ul class=\"list-unstyled list-inline\">\r\n");
      out.write("                                            <li><a href=\"#\" class=\"text-muted\">");
 out.print(p.getDatentime()); 
      out.write("</a></li>\r\n");
      out.write("                                        </ul>\r\n");
      out.write("\r\n");
      out.write("                                    </div>\r\n");
      ...
      out.write("                                        <div class=\"pic-wrapper col-md-1 col-sm-1 col-xs-2 text-center\">\r\n");
      out.write("                                            <img src=\"../GetIconByID?id=");
 out.print(pm.getEmployeeid()); 
      out.write("\" alt=\"\">\r\n");
      out.write("                                        </div>\r\n");
      out.write("                                            \r\n");
      out.write("                                        <div class=\"info-wrapper col-md-11 col-sm-11 col-xs-10\">\t\t\t\t\t\r\n");
      out.write("                                            <div class=\"username\">\r\n");
      out.write("                                                <span>Project Manager </span><span class=\"bold\">");
 out.print(pm.getEmployeename()); 
      out.write("</span> <span>Approved</span><span> the document</span> <!-- approved or Reject if approved view the stake holders-->\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                            <div class=\"info text-muted\">\r\n");
      out.write("                                                <span class=\"bold\">Added Stakeholders</span><br/>\r\n");
      out.write("                                                \r\n");
      out.write("                                             \r\n");
      out.write("                                                \r\n");
      out.write("                                                ");
      ...
      out.write("                                                \r\n");
      out.write("                                                <span>");
 out.print(sh.getName()); 
      out.write(' ');
      out.write('(');
 out.print(sh.getDepartment()); 
      out.write(")</span><br/>\r\n");
      out.write("                                                ");
 } 
      out.write("\r\n");
      ...
      out.write("                                            <div class=\"info-details\">\r\n");
      out.write("                                                <ul class=\"list-unstyled list-inline\">\r\n");
      out.write("                                                    <!--<li><a href=\"#\" class=\"text-muted\">8 Minutes ago</a></li>-->\r\n");
      out.write("                                                    \r\n");
      out.write("                                                </ul>\r\n");
      out.write("                                            </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                                        <div class=\"pic-wrapper col-md-1 col-sm-1 col-xs-2 text-center\">\r\n");
      out.write("                                            <img src=\"../GetIconByID?id=");
 out.print(ba.getEmployeeid()); 
      out.write("\" alt=\"\">\r\n");
      out.write("                                        </div>\r\n");
      out.write("                                        <div class=\"info-wrapper col-md-11 col-sm-11 col-xs-10\">\t\t\t\t\t\r\n");
      out.write("                                            <div class=\"username\">\r\n");
      out.write("                                                <span>Business Analyst </span><span class=\"bold\">");
 out.print(ba.getEmployeename()); 
      out.write("</span> <span>Uploaded the</span> <span class=\"bold\">SRS</span>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                            <div class=\"info text-muted\">\r\n");
      out.write("                                                <span class=\"bold\"></span><span class=\"bold\"><a href=\"../GetSRSByVersion?version=");
 out.print(d.getSrsversion()); 
      out.write("\">SRS Version ");
 out.print(d.getSrsversion()); 
      out.write("</a></span>\r\n");
      out.write("                                            </div>\t\r\n");
      out.write("                                            <div class=\"info-details\">\r\n");
 ...
 out.print(d.getDate()); 
      ...
      out.write("\r\n");
      out.write("                                    <div class=\"clearfix\"></div>\r\n");
      out.write("                                    <div class=\"comment\" style=\"padding-left: 2cm;\">\r\n");
      out.write("                                        <div class=\"pic-wrapper col-md-1 col-sm-1 col-xs-2 text-center\">\r\n");
      out.write("                                            <img src=\"../GetIconByID?id=");
 out.print(sh.getEmpid()); 
      out.write("\" alt=\"\">\r\n");
      out.write("                                        </div>\r\n");
      out.write("                                        <div class=\"info-wrapper col-md-11 col-sm-11 col-xs-10\">\r\n");
      out.write("                                            \r\n");
      out.write("                                            <div class=\"username\">\r\n");
      out.write("                                                <span>External Stakeholder </span><span class=\"bold\">");
 out.print(sh.getName()); 
      out.write(' ');
      out.write('(');
 out.print(sh.getDepartment()); 
 ...
 out.print(st); 
      ...
      out.write("                                            <div class=\"info-details\">\r\n");
      out.write("                                                <ul class=\"list-unstyled list-inline\">\r\n");
      out.write("                                                    <li><a href=\"#\" class=\"text-muted\"></a></li>\r\n");
      out.write("                                                    \r\n");
      out.write("                                                </ul>\r\n");
      out.write("                                            </div>\r\n");
      out.write("\r\n");
