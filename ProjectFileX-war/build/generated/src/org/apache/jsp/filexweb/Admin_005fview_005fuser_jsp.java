...
out.print(e.getDepartement());
 ...
 out.print(session.getAttribute("home")); 
    ...
    ArrayList<Employee> employee = Employee.getEmployee();
      ...
      out.write("                                            <img class=\"img-circle img-inline\" width=\"200px\" height=\"200px\" src=\"../GetIconByID?id=");
out.print(emp.getEmployeeid());
 ...
 out.print(emp.getEmployeename()); 
      out.write("</h4>\r\n");
      out.write("                                            <span style=\"color:black\">User ID : </span><span>");
out.print(emp.getEmployeeid());
      out.write("</span><br/>\r\n");
      out.write("                                            <span>");
 out.print(emp.getPosition()); 
      out.write("</span><br/>\r\n");
      out.write("                                            <span>");
 out.print(emp.getEmail()); 
      ...
      out.write("                                        </div>\r\n");
      out.write("                                        <p>");
 out.print(emp.getDepartmentid()); 
      out.write("</p>\r\n");
      out.write("                                        <ul class=\"social-icons list-inline list-unstyled\">\r\n");
      out.write("                                            <li><a href=\"Admin_edit_user.jsp?id=");
out.print(emp.getEmployeeid());
      out.write("&email=");
out.print(emp.getEmail());
      out.write("\"><i class=\"fa fa-gear icon-bordered icon-primary icon-xs\"></i></a></li>\r\n");
      out.write("                                            <li><a data-toggle=\"modal\" href=\"#\" data-target=\"#ultraModal");
out.print(i);
      out.write("\" title=\"Delete User\"><i class=\"fa fa-trash-o icon-bordered icon-primary icon-xs\"></i></a></li>\r\n");
      out.write("                                        </ul>\r\n");
...
out.print(i);
      ...
      out.write("                                                        Once a user is deleted, you will not be able to recover it.\r\n");
      out.write("                                                    </div>\r\n");
      out.write("                                                    <div class=\"modal-footer\">\r\n");
      out.write("                                                        <button data-dismiss=\"modal\" class=\"btn btn-default\" type=\"button\">Cancel</button>\r\n");
      out.write("                                                        <a  href=\"../DeleteEmp?id=");
out.print(emp.getEmployeeid());
