 ...
 * @author Ashantha
 */
public class HoldProject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (status.equals("hold")) {
                ...
                ps.executeQuery();
                con.close();
                response.sendRedirect("filexweb/PM_Projects.jsp?scs=hold");

            } else if (status.equals("continue")) {
                PreparedStatement ps = con.prepareStatement("update project set status='ongoing' where pno='" + pno + "'");
                ps.executeQuery();
                con.close();
