                        ...
                        <div class="cuadro_intro_hover " style="background-color:#CECEE9; width:300;">
                            ...
                            <div class="caption">
                                ...
                                <div class="caption-text">
                                    ...
                                    <button type="button" class="btn btn-warning" style="margin-top:3; width:140;" onclick="isSrsUploaded();">SRS</button><br/>
...
<!--Model starts-->
<div class="modal fade" id="SRSnotRejected" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true" style="display: none;">
    <div class="modal-dialog animated fadeInUp"><br/><br/><br/><br/><br/><br/><br/><br/><br/>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
