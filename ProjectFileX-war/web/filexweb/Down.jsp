...
<!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
<script src="plugins/daterangepicker/js/moment.min.js" type="text/javascript"></script> 
<script src="plugins/daterangepicker/js/daterangepicker.js" type="text/javascript"></script> 
